...
<nav class="navbar navbar-expand-lg bg-dark">
    ...
    <?php
        include 'koneksi.php';
        $id = $_GET['id'];
        $sql	= "SELECT * FROM pakaian WHERE id_pakaian = '$id'";
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form method="POST" action="input_cart.php">
                    <input type="hidden" name="id_pakaian"  value="<?= $data['id_pakaian']; ?>" class="input">
                    ...
                    <div style="width: 660px; margin-top: 15px; display: inline-flex;">
                        <input type="submit" name=""  class="btn btn-outline-success" value="Add to cart" class="input">
                    </div>
                </form>
            </div>
        </div>
